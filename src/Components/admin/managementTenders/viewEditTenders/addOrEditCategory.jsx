  ...
  useEffect(() => {
    if (initialData) {
      setFormData({
        ...
        monthlyPrice: initialData.price_monthly || '',
        subscriptionPrice: initialData.price_subscription || ''
      });
    } else {
      setFormData({
        category: '',
...
<<<<<<< HEAD
  ...
  const handleSubmit = (e) => {
    ...
    if (formIsValid) {
      handleSave({
        ...formData,
        price_monthly: parseFloat(formData.monthlyPrice),
        price_subscription: parseFloat(formData.subscriptionPrice)
      });
      handleClose();
    }
  };
    ...
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogContent>
        ...
        <TextField
          ...
          helperText={errors.monthlyPrice ? 'שדה חובה או מחיר לא חוקי' : ''}
          margin="dense"
          name="monthlyPrice"
          label="מחיר חודשי"
          type="number"
        ...
        <TextField
          ...
          helperText={errors.subscriptionPrice ? 'שדה חובה או מחיר לא חוקי' : ''}
          margin="dense"
